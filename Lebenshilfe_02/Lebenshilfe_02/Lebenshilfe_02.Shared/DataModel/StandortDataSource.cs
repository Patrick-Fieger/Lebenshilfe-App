...
namespace Lebenshilfe_02.Data
{
    ...
    /// </summary>
    public class StandortDataItem
    {
        public StandortDataItem(String uniqueId, String title, String subtitle, String imagePath, String description, String content)
        {
    ...
    public class SampleDataGroup
    {
        public SampleDataGroup(String uniqueId, String title, String subtitle, String imagePath, String description)
        {
            ...
            this.Description = description;
            this.ImagePath = imagePath;
            this.Items = new ObservableCollection<StandortDataItem>();
        }
        ...
        public string Description { get; private set; }
        public string ImagePath { get; private set; }
        public ObservableCollection<StandortDataItem> Items { get; private set; }
        ...
        private async Task GetSampleDataAsync()
        {
            ...
            foreach (JsonValue groupValue in jsonArray)
            {
                ...
                foreach (JsonValue itemValue in groupObject["Items"].GetArray())
                {
                    ...
                    group.Items.Add(new StandortDataItem(itemObject["UniqueId"].GetString(),
