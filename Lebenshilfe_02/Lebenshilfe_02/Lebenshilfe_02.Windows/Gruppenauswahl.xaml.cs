...
namespace Lebenshilfe_02
{
    ...
    public sealed partial class GruppenAuswahlPage : Page
    {
        ...
        private async void NavigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            var group = await GruppeDataSource.GetGruppeAsync("Standort-MUC");
            //var group = await GruppeDataSource.GetGruppenAsync();
            this.DefaultViewModel["Gruppenauswahl"] = group;
        }
