...
namespace Lebenshilfe_02
{
    ...
    public sealed partial class HubPage : Page
    {
        ...
        /// </summary>
        /// <param name="sender">Die Quelle des Click-Ereignisses.</param>
        /// <param name="e">Details zum Click-Ereignis.</param>
        ...
        /// </summary>
        /// <param name="sender">Die Quelle des Click-Ereignisses.</param>
        /// <param name="e">Standardwerte für das Click-Ereignis.</param>
        private void ItemView_ItemClick(object sender, ItemClickEventArgs e)
        {
            var itemId = ((StandortDataItem)e.ClickedItem).UniqueId;
