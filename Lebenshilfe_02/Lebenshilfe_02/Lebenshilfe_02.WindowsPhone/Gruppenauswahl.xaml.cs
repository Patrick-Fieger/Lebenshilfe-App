...
namespace Lebenshilfe_02
{
    ...
    /// </summary>
    public sealed partial class GruppenAuswahlPage : Page
    {
        ...
        private async void NavigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            var sampleDataGroup = await GruppeDataSource.GetGruppeAsync((string)e.NavigationParameter);
            //var groups = await GruppenDataSource.GetGruppenAsync();
            this.DefaultViewModel["Group"] = sampleDataGroup;
        }
